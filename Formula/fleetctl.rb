class Fleetctl < Formula
  FLEET_VERSION = "4.86.1".freeze
  desc "Command-line interface for Fleet Device Management"
  homepage "https://fleetdm.com"
  license "MIT"

  if OS.mac?
    url "https://github.com/fleetdm/fleet/releases/download/fleet-v#{FLEET_VERSION}/fleetctl_v#{FLEET_VERSION}_macos.zip"
    sha256 "ab6510afc7686f5416596da16476b5a996dfa86d5b7dded6d77f85ff228f96a0"
  elsif OS.linux?
    if Hardware::CPU.intel?
      url "https://github.com/fleetdm/fleet/releases/download/fleet-v#{FLEET_VERSION}/fleetctl_v#{FLEET_VERSION}_linux_amd64.zip"
      sha256 "2883b8166c8b09a584de75708558c926b74df4eab48229972b098d40570952d0"
    end

    if Hardware::CPU.arm?
      url "https://github.com/fleetdm/fleet/releases/download/fleet-v#{FLEET_VERSION}/fleetctl_v#{FLEET_VERSION}_linux_arm64.zip"
